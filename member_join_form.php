...
<body>
    <div class="bookshelf">
        <img src="./images/books.jpg" alt="bookshelf" width="1350px" height="150px">
    </div>   
    <table class="content-table" style="margin-left:auto;margin-right:auto;padding:2px;border-spacing:20px;">
        <tr valign="top">
        <td width="500">
           <form name="form1" method="post" action="member_join.php" onSubmit="return checkForm()"><br>
                    <h1 style="font-size:30px;">Library Member Register Form</h1>
                    <hr size="1"><br>
    ...
    <?php 
        if (isset($_GET["msg"]) && $_GET["msg"] == 'failed') 
        {
            ...
            echo "alert('Username is taken,please try another username')"; 
            echo "</script>";  
        }
    ?> 
</body>
